    ...
    <div className="max-w-4xl mx-auto">
        ...
        <nav className="-mb-px flex space-x-8">
          {tabs.map(({ id, label, icon: Icon }) => (
            ...
            >
              <Icon className={`
                mr-2 h-5 w-5
                ${activeTab === id ? 'text-primary-500' : 'text-gray-400 group-hover:text-gray-500'}
              `} />
              {label}
            </button>
          ))}
      ...
      <div className="mt-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive updates about your trips and matches</p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive travel tips and special offers</p>
                </div>
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
        ...
        {activeTab === 'preferences' && (
          <div className="space-y-6">
            <h2 className="text-lg font-medium text-gray-900">Travel Preferences</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Share your location with other travelers</p>
                </div>
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
